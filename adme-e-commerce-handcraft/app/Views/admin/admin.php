...
<div class="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row heading-bg">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h5 class="txt-dark">Data Admin</h5>
            </div>
            <!-- Breadcrumb -->
    ...
    <!-- Modal Add Category-->
    <form action="<?= route_to('admin_admin_save') ?>" method="post">
        <?= csrf_field()?>
    ...
    <!-- Modal Edit Product-->
    <form action="<?= route_to('admin_admin_update') ?>" method="post">
    ...
    <form action="<?= route_to('admin_admin_delete') ?>" method="post">
        <?= csrf_field() ?>
